...
meshes_dynamic = []
mesh_dynamic_1 = Mesh("../models/OBJ/square_big.obj", scale=0.1, trans=ti.math.vec3(0.0, 1.5, 0.0), rot=ti.math.vec3(0.0, 40.0, 0.0))
...
mesh_dynamic_2 = Mesh("../models/OBJ/square_big.obj", scale=0.1, trans=ti.math.vec3(0.0, 1.3, 0.0), rot=ti.math.vec3(0.0, 40.0, 0.0))
...
tet_mesh_dynamic_1 = TetMesh("../models/MESH/bunny_tiny.1.node",  scale=0.3, trans=ti.math.vec3(0.0, -0.8, 0.0), rot=ti.math.vec3(0.0, 0.0, 0.0))
tet_mesh_dynamic_2 = TetMesh("../models/MESH/bunny_tiny.1.node", scale=0.3, trans=ti.math.vec3(2.0, -0.8, 0.0), rot=ti.math.vec3(0.0, 0.0, 0.0))
...
particles = []
particle_1 = Particle('../models/VTK/cube87K.vtk', trans=ti.math.vec3(0.0, 0.0, 0.0), scale=1.5, radius=0.01)
...
sim = xpbd.Solver(meshes_dynamic, meshes_static, tet_meshes_dynamic, particles, g=ti.math.vec3(0.0, -9.81, 0.0), dt=0.01, grid_size=ti.math.vec3(5.0, 2.0, 2.0), particle_radius=0.02)
