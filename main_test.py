...
x_np_temp, edges, faces = import_mesh("models/OBJ/plane_8.obj",  scale = 3.0, translate = [0.0, 0.0, 0.0], rotate = [1., 0., 0., 0.0])
...
def forward():
    ...
    for _ in range(num_iters):
        ...
        if enable_detection:
            detect_collision(x_k, radius, center)
            compute_grad_and_hessian_collision(x_k, radius, center, k=k_col)
