...
meshes_dynamic = []
mesh_dynamic_1 = Mesh("../models/OBJ/plane.obj", scale=4.0, trans=ti.math.vec3(0.0, 0.0, 3), rot=ti.math.vec3(20.0, 0.0, 0.0))
...
meshes_static = []
mesh_static_1 = Mesh("../models/OBJ/plane.obj", scale=9, trans=ti.math.vec3(0.0, -2.0, 0.0), rot=ti.math.vec3(20.0, 0.0, 0.0), is_static=True)
