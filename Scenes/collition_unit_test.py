...
meshes_dynamic = []
mesh_dynamic_1 = Mesh("../models/OBJ/tet.obj", scale=2.0, trans=ti.math.vec3(0.2, 1.0, -0.2), rot=ti.math.vec3(0.0, 0.0, 45.0))
...
meshes_static = []
mesh_static_1 = Mesh("../models/OBJ/tet.obj", scale=2.0, trans=ti.math.vec3(0.0, -1.0, 0.0), rot=ti.math.vec3(0.0, 90.0, 0.0))
