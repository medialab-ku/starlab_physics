...
mesh_dy = MeshTaichiWrapper("../models/OBJ/plane.obj", offsets=[0], scale=8.0, trans=ti.math.vec3(0, 3.0, 0), rot=ti.math.vec3(0.0, 0.0, 0.0))
...
# mesh_st = MeshTaichiWrapper("../models/OBJ/APoseSMPL.obj",  offsets=[0], scale=1.5, trans=ti.math.vec3(0.0, 0.0, 0.0), rot=ti.math.vec3(0.0, 0.0, 0.0), is_static=True)
# mesh_st = MeshTaichiWrapper("../models/concat.obj",  offsets=[0], scale=3.0, trans=ti.math.vec3(0.0, 0.0, 0.0), rot=ti.math.vec3(0.0, 0.0, 0.0), is_static=True)