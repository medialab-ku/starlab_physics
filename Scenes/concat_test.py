...
mesh_dy = MeshTaichiWrapper("../models/OBJ/plane.obj", offsets=[0], scale=5.0, trans=ti.math.vec3(0, 5.0, 0), rot=ti.math.vec3(0.0, 0.0, 0.0))
mesh_st = None
...
mesh_st = MeshTaichiWrapper("../models/concat.obj",  offsets=[0], scale=5.0, trans=ti.math.vec3(0.0, 0.0, 0.0), rot=ti.math.vec3(0.0, 0.0, 0.0), is_static=True)