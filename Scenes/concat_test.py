...
mesh_dy = MeshTaichiWrapper("../models/OBJ/BasicTShirt.obj", offsets=[0], scale=0.01, trans=ti.math.vec3(0, -13, 0), rot=ti.math.vec3(0.0, 0.0, 0.0))
mesh_st = None
...
mesh_st = MeshTaichiWrapper("../models/concat.obj",  offsets=[0], scale=1.0, trans=ti.math.vec3(0.0, 1.0, -0.2), rot=ti.math.vec3(0.0, 0.0, 0.0), is_static=True)