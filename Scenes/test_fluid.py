...
meshes_static = []
mesh_static_1 = Mesh("../models/OBJ/sphere1K.obj", scale=8, trans=ti.math.vec3(0.0, 0.0, 0.0), rot=ti.math.vec3(0.0, 0.0, 0.0), is_static=True)
...
particle_2 = Particle('../models/VTK/cube1K.vtk', trans=ti.math.vec3(0.0, -2.0, 0), scale=4, radius=0.01)
