...
meshes_static = []
# mesh_static_1 = Mesh("../models/OBJ/torus3K.obj", scale=2.0, trans=ti.math.vec3(3.0, 0.0, 0.0), rot=ti.math.vec3(90.0, 0.0, 90.0), is_static=True)
# mesh_static_2 = Mesh("../models/OBJ/torus3K.obj", scale=2.0, trans=ti.math.vec3(-3.0, 0.0, 0.0), rot=ti.math.vec3(90.0, 0.0, 90.0), is_static=True)
