...
meshes_dynamic = []
mesh_dynamic_1 = Mesh("../models/OBJ/plane.obj", scale=5.0, trans=ti.math.vec3(0.0, 1.0, 0.0), rot=ti.math.vec3(0.0, 0.0, 0.0))
mesh_dynamic_2 = Mesh("../models/OBJ/plane.obj", scale=5.0, trans=ti.math.vec3(0.0, 1.3, 0.0), rot=ti.math.vec3(0.0, 0.0, 20.0))
mesh_dynamic_3 = Mesh("../models/OBJ/plane.obj", scale=5.0, trans=ti.math.vec3(0.0, 1.6, 0.0), rot=ti.math.vec3(0.0, 0.0, 40.0))
mesh_dynamic_4 = Mesh("../models/OBJ/plane.obj", scale=5.0, trans=ti.math.vec3(0.0, 1.9, 0.0), rot=ti.math.vec3(0.0, 0.0, 60.0))
mesh_dynamic_5 = Mesh("../models/OBJ/plane.obj", scale=5.0, trans=ti.math.vec3(0.0, 2.2, 0.0), rot=ti.math.vec3(0.0, 0.0, 80.0))
