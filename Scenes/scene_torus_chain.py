...
tet_meshes_dynamic = []
tet_mesh_dynamic_1 = TetMesh("../models/MESH/torus3k.1.node", scale=2.0, trans=ti.math.vec3(0.0, -1.0, 0.0), rot=ti.math.vec3(0,0,0), is_static=True) # 10k element
tet_mesh_dynamic_2 = TetMesh("../models/MESH/torus3k.1.node", scale=2.0, trans=ti.math.vec3(0.0, -1.0, 0.0), rot=ti.math.vec3(0,0,0), is_static=True) # 10k element
tet_mesh_dynamic_3 = TetMesh("../models/MESH/torus3k.1.node", scale=2.0, trans=ti.math.vec3(0.0, -1.0, 0.0), rot=ti.math.vec3(0,0,0), is_static=True) # 10k element
