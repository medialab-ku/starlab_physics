...
# sim = XPBF.Solver()
sh = SH.SpatialHash(grid_resolution=(64, 64, 64))
...
while window.running:
    ...
    # scene.particles(sim.mesh_dy.particles.particles_per_face_field, radius=0.05, color=(1.0, 1.0, 0.0))
    # if sim.mesh_st != None:
