...
# Register SwigPyIterator in _partio:
_partio.SwigPyIterator_swigregister(SwigPyIterator)
...
class ParticlesDataMutable(ParticlesData):
    ...
    def ptr(self):
        r"""
        ptr(ParticlesDataMutable self) -> unsigned long long
...
def merge(*args):
    r"""
    merge(ParticlesDataMutable base, ParticlesData delta, std::string const & identifier0=std::string(), std::string const & identifier1=std::string())
...
def cloneSchema(other, attrNameMap=None):
    r"""
    cloneSchema(ParticlesData other, std::map< std::string,std::string,std::less< std::string >,std::allocator< std::pair< std::string const,std::string > > > const * attrNameMap=None) -> ParticlesDataMutable
...
def clone(other, particles, attrNameMap=None):
    r"""
    clone(ParticlesData other, bool particles, std::map< std::string,std::string,std::less< std::string >,std::allocator< std::pair< std::string const,std::string > > > const * attrNameMap=None) -> ParticlesDataMutable
