...
class TriMesh:
    def __init__(
        ...
        self.a_dup = ti.Matrix.field(n=3, m=3, dtype=float, shape=offset_vert[-1])
        self.a_dup_tilde = ti.Matrix.field(n=3, m=3, dtype=float, shape=offset_vert[-1])
        self.b_dup = ti.Matrix.field(n=3, m=3, dtype=float, shape=offset_vert[-1])
        self.c_dup = ti.Matrix.field(n=3, m=3, dtype=float, shape=offset_vert[-1])
        self.c_dup_tilde = ti.Matrix.field(n=3, m=3, dtype=float, shape=offset_vert[-1])
