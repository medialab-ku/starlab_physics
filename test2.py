...
dt = 0.002  # Larger dt might lead to unstable results.
...
# static_mesh = Mesh("obj_models/tetrahedron.obj", scale=0.3, rot=ti.math.vec3(180.0, 0.0, 50.0), trans=ti.math.vec3(0.3, 0.2, 0.3))
